...
<jsp:useBean id="pagination" class="com.poppy.tools.MyPagination"
	scope="session" />
...
<link rel="stylesheet" href="CSS/listAllDiary.css" />
	...
	<div id="box">
		...
		<c:if test="${!empty requestScope.diaryList}">
			<c:forEach items="${requestScope.diaryList}" var="diaryList"
				...
				<div id="main1">
					<font id="font1">${diaryList.username}</font>&nbsp;&nbsp;发表九宫格日记：<b>${diaryList.title}</b>
				</div>
				<div id="main2">
					<div id="diaryImg${id.count }"
						...
						<div id="control${id.count }" style="display:none;padding: 10px;">
							...
							%>
							<a href="#"
								onClick="zoom('${id.count }','${diaryList.address }')">收 缩</a>
							&nbsp;&nbsp; <a
								href="<%=url %>/images/diary/${diaryList.address }.png"
								target="_blank">查看原图</a> &nbsp;&nbsp; <a
								id="rotLeft${id.count }" href="#">左转</a> &nbsp;&nbsp; <a
								id="rotRight${id.count }" href="#">右转</a> <a
