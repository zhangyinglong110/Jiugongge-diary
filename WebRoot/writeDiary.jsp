					...
					<ul id="gridLayout">
						<li>
							<div class="cssContent">
								<ul id="opt">
									<li><input name="content" type="text" size="30"
						...
						<li>
							<div class="cssContent">
								<ul id="opt">
								    ...
								    <li><a href="#" onClick="document.getElementsByName('content')[3].value='不再空想了'">◎ 不再空想了</a></li>
								 </ul>	    
							</div>
						</li>
						<li>
						...
						<li>
							<div class="cssContent">
								<ul id="opt">
								    ...
								    <li><a href="#" onClick="document.getElementsByName('content')[5].value='神马都是浮云'">◎ 神马都是浮云</a></li>
								 </ul>
							</div>
						 </li>
 						 <li>
						 	<div class="cssContent">
								<ul id="opt">
								    ...
								    <li><a href="#" onClick="document.getElementsByName('content')[6].value='新闻联播'">◎ 新闻联播</a></li>
								</ul>
							</div>
						  </li>
						  <li>
						  ...
						  <li>
							 <div class="cssContent">
							 	<ul id="opt">
								    ...
								    <li><a href="#" onClick="document.getElementsByName('content')[8].value='努力做好自己'">◎ 努力做好自己</a></li>
								 </ul>
							</div>
						 </li>
					</ul>
