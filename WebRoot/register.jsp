...
<div id="register" class="registerMain">
	<form name="form1" action="" method="post">
		<table width="450" height="100%" bgcolor="#FEFEFC" border="0">
			<tr>
				<td height="408" align="center" valign="top">
					...
					<table width="450" height="331" border="0">
						<tr>
							<td height="310" valign="top" bgcolor="#FFFFFF">
								<table border="1" bgcolor="#FFFEF9">
						<tr id="tr_user" style="display:none">
							<td height="40" colspan="2" align="center">
								<div id="div_user"
									style="border:#FF6600 1px solid; color:#FF0000; width:90%; height:29px; padding-top:8px;">
								</div>
							</td>
						</tr>
						<tr>
							<td width="170" height="40" align="right">用户名：</td>
							<td height="40" align="left"><input name="user" type="text"
								onBlur="checkUser(this.value)"> &nbsp;*长度限制为20个字母或10个汉字
							</td>
						</tr>
						<tr id="tr_pwd" style="display:none">
							<td height="40" colspan="2" align="center">
								<div id="div_pwd"
									style="border:#FF6600 1px solid; color:#FF0000; width:90%; height:29px; padding-top:8px; background-image:url(images/div_bg.jpg)">
								</div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td height="40" align="left"><input name="email" type="text"
								size="35" onBlur="checkEmail(this.value)"> &nbsp;*
